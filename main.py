    ...
    def run_ollama_agent(self, user_text):
        ...
        if target_lang == "en":
            ...
            sys_prompt = (
                ...
                f"{security_info}\n\n"
                "INTERNAL THOUGHTS:\n"
                "CRITICAL: Put ALL planning, technical analysis, code snippets, and terminal logs interpretation inside `<thought>...</thought>` tags.\n"
                ...
                "RULES:\n"
                "1. EXTREME BREVITY: Your spoken response must be max 1-2 short sentences. Summarize what you did or will do.\n"
                "2. NO TECHNICAL JUNK: Do not read out file paths, version numbers, or log details. Just say 'Task completed' or 'I am installing X'.\n"
                "3. LANGUAGE: Always respond in ENGLISH.\n"
                "4. STEP BY STEP: One tool at a time."
            )
        else:
            # Standard: Deutsch
            security_info = ""
            ...
            sys_prompt = (
                ...
                f"{security_info}\n\n"
                "INTERNES DENKEN:\n"
                "WICHTIG: Schreibe ALLE Planungen, technischen Analysen und Interpretationen von Terminal-Logs AUSSCHLIESSLICH in `<thought>...</thought>` Tags.\n"
                "Der Nutzer hört NICHT, was in diesen Tags steht.\n\n"
                "WERKZEUGE:\n"
                ...
                "{ \"tool\": \"get_system_info\", \"kwargs\": {} }\n\n"
                "REGELN:\n"
                "1. EXTREME KÜRZE: Deine gesprochene Antwort muss extrem kurz sein (max. 1-2 Sätze). Fasse nur zusammen, was du tust oder getan hast.\n"
                "2. KEIN TECHNIK-MÜLL: Lies keine Dateipfade, Versionsnummern oder Tabellen vor. Sag einfach 'Installation fertig' oder 'Ich suche nach X'.\n"
                "3. SPRACHE: Antworte IMMER auf DEUTSCH (außer der Nutzer spricht Englisch).\n"
                "4. SCHRITT FÜR SCHRITT: Führe immer nur EIN Werkzeug aus."
            )
